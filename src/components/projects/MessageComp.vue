<template>
    <div class="flex flex-col md:max-w-md space-y-4 p-3 text-gray-600 text-[13px] md:text-[15px] dark:text-gray-300 leading-relaxed border border-gray-400 dark:border-gray-600 rounded-xl">
        ...
        <div class="flex justify-between w-full space-x-3">
            <a href="https://github.com/murigugitonga" class="flex py-2.5 items-center justify-center w-full space-x-6 text-gray-500 dark:text-gray-200 bg-white border border-black dark:border-none dark:bg-[#333535] rounded-xl">
                <!--Dark mode-->
                <svg viewBox="0 0 496 512" fill="#000" class="w-8 h-8 dark:invert" xmlns="http://www.w3.org/2000/svg">
            ...
            <a href="https://www.behance.net/murigugitonga" class="flex py-2.5 items-center justify-center w-full space-x-6 text-gray-800 dark:bg-[#333535] bg-white border dark:text-gray-500 border-black rounded-xl">
                <svg xmlns="http://www.w3.org/2000/svg" class="w-8 h-8 dark:invert" viewBox="0 0 50 50"> 
