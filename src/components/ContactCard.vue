...
const contacts = [
    ...
    },
    {
        ...
        alt: "Gmail",
        isGmail: true,
        link: "#", // overridden by custom click handler
    },
]
...
async function handleClick(contact) {
    ...
    setTimeout(() => {
        ...
        // ======================
        // MOBILE DEVICES → GMAIL APP FIRST
        // ======================
        if (isMobile) {
            // mailto: always prioritizes Gmail on Android if installed
            window.location.href = mailtoLink
            return
        }

        // ======================
        // DESKTOP DEVICES → GMAIL WEB
        // ======================
...
<template>
    <div class="flex flex-col space-y-5 font-medium pe-5">
        ...
        >
            ...
            <svg class="w-2 h-5 dark:invert" viewBox="0 0 6 10" xmlns="http://www.w3.org/2000/svg">
                <path
