<template>
    <div class="flex flex-col md:max-w-md space-y-4 p-3 text-[17px] text-gray-600 dark:text-gray-300 leading-relaxed border bordr-gray-700 darK:border-gray-800 rounded-xl">
        ...
        <div class="flex justify-between w-full space-x-3">
            <a href="https://github.com/adrianmdevs" class="flex items-center justify-center w-full py-2 space-x-6 text-gray-200 bg-black rounded-xl">
                <!--Dark mode-->
            ...
            <a href="#" class="flex items-center justify-center w-full py-2 space-x-6 text-gray-800 bg-white border border-black rounded-xl">
                ...
                <span class="font-medium">Behance</span>
            </a>
        </div>
    </div>
</template>